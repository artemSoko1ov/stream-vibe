...
const PlansComparison = () => {
  ...
  return (
    <Section
      ...
      description="StreamVibe offers three different plans to fit your needs: Basic, Standard, and Premium. Compare the features of each plan and choose the one thats right for you."
    >
        <Table 
            headCells={headCells}
            rows={rows}
